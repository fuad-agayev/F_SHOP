    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div class="space-y-4">
        ...
        <div class="relative">
          ...
          <div 
            ref="zoomContainer"
            class="relative overflow-hidden rounded-lg cursor-zoom-in"
          ...
          <div 
            v-show="showZoom"
            class="absolute top-0 left-[calc(100%+1rem)] w-[400px] h-96 rounded-lg overflow-hidden border border-gray-200 shadow-lg bg-white"
          >
            <div 
              class="w-full h-full"
              :style="{
      ...
      <div class="flex flex-col">
        ...
        <button 
          ...
          class="w-full bg-blue-600 text-white py-4 px-6 rounded-lg hover:bg-blue-700 transition-all transform hover:scale-[1.02] active:scale-[0.98] font-semibold text-lg shadow-md"
        >
          Add to Cart
        </button>
      </div>
